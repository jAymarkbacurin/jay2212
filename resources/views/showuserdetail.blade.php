                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="w-full md:w-1/2">
                                        <a >
                                            <button type="submit" class="text-yellow-500 hover:text-white mx-[2rem]   hover:border-yellow-600 border-slate-900 border-b-[1px]  text-center py-[6px] text-[13px]   transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300">USER DETAIL
                                            </button>
                                        </a>
                                ...
                                <div class="">
                                    <section class="p-3 sm:p-5">
                                        ...
                                        <form action="{{ route('Showuserdetail') }}" method="post" class="shadow-2xl max-w-md mb-[2rem] border-yellow-600 border-[2px]  dark:bg-slate-900 p-[4rem]">
                                            @csrf
                                            <div class="relative z-0 w-full mb-5 group">
                                                <input value='{{ $user->id }}' type="number" name="id" id="id"
